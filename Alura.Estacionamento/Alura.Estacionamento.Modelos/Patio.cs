...
namespace Alura.Estacionamento.Modelos
{
    public class Patio
    {
        ...
        {
            var veiculoEncontrado = Veiculos.Find(veiculo => veiculo.IdTicket == idTicket);
        ...
        {
            var veiculoTemp = Veiculos.Find(veiculo => veiculo.Placa == veiculoAlterado.Placa);
        ...
        private string GerarTicket(Veiculo veiculo)
        {
            ...
            string ticket = "### Ticket Estacionamento Alura ###" +
                ...
                $">>> Operador Pátio: {OperadorPatio.Nome}";
